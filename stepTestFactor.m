...
% is enough for a fair amount of sims

sizeN = 1000; %Size of the array
...
randIgn = true; %Approximates random numbers as 0.5 to speed up execution
saveVideo = false; %Saves all states, then plays an animation of them here
mode = "GPU"; %Calculation mode, see stepState for more
